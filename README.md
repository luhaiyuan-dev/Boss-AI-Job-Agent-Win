...
| 结果筛选 | 岗位、地点、投递情况按“且”关系组合；地点选项来自目标城市；投递情况可选全部、未投递、已填充未发送、发送成功、处理失败、发送失败；岗位支持全称或部分关键词，设置后点击“筛选”生效 |
...
当前 `0.2.1` 基线、自动化流程修复与既有 Nuitka 构建/环境包校验结果见 [VALIDATION_REPORT.md](VALIDATION_REPORT.md)。
